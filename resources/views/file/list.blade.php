                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="fileOptions">
                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#editFilerModal" onclick="editFile()">
                                            <i class="fas fa-edit"></i> Rename
                                        </a>
                                        <a class="dropdown-item" href="{{ asset('Uploads/' . $file->file) }}" target="_blank">
                                            <i class="fas fa-eye"></i> View
                                        </a>
                                        <a class="dropdown-item btn btn-danger btn-sm" href="{{ route('deleteFile', $file->id) }}">
