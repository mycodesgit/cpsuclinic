...
use Yajra\Address\Models\City;
use Yajra\Address\Models\Region;
use Yajra\Address\Models\Province;
use Yajra\Address\Models\Barangay;
...
class AddressSeeder extends Seeder
{
    public function run()
    {
        $publication = config('address.publication.path', public_path('publication/PSGC_Publication_Dec2019.xlsx'));
